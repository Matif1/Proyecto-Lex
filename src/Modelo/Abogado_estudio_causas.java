 ...
 * @author XPS 9560
 */
public class Abogado_estudio_causas extends Abogado 
{
    String mail;

    public Abogado_estudio_causas(String mail, String usuario, String contrasena) {
    ...
    public String toString() {
        return "Abogado_estudio_causas{" + "mail=" + mail + '}';
    }
